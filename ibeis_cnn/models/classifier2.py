    ...
    def get_classifier2_def(model, verbose=ut.VERBOSE, **kwargs):
        ...
        network_layers_def = (
            [
                ...
                _P(Conv2DLayer, num_filters=32, filter_size=(3, 3), name='C3', W=init.Orthogonal('relu'), **hidden_initkw),
                _P(MaxPool2DLayer, pool_size=(2, 2), stride=(2, 2), name='P3'),

                _P(Conv2DLayer, num_filters=32, filter_size=(3, 3), name='C4', W=init.Orthogonal('relu'), **hidden_initkw),

                _P(Conv2DLayer, num_filters=32, filter_size=(3, 3), name='C5', W=init.Orthogonal('relu'), **hidden_initkw),

                _P(layers.DenseLayer, num_units=128, name='F0',  **hidden_initkw),
...
if __name__ == '__main__':
    """
    CommandLine:
        python -m ibeis_cnn.models.classifier2
        python -m ibeis_cnn.models.classifier2 --allexamples
        python -m ibeis_cnn.models.classifier2 --allexamples --noface --nosrc
    """
