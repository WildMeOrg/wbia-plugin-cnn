    ...
    def get_aoi2_def(model, verbose=ut.VERBOSE, **kwargs):
        ...
        network_layers_def = (
            [
                ...
                _P(layers.DenseLayer, num_units=1, name='F2', nonlinearity=nonlinearities.softmax),
            ]
        )
...
def train_aoi2(output_path, data_fpath, labels_fpath, purge=True):
    r"""
    CommandLine:
        python -m ibeis_cnn.train --test-train_aoi2
...
if __name__ == '__main__':
    """
    CommandLine:
        python -m ibeis_cnn.models.aoi2
        python -m ibeis_cnn.models.aoi2 --allexamples
        python -m ibeis_cnn.models.aoi2 --allexamples --noface --nosrc
    """
